...
def add_frame(procedure, run_mode, image, drawables, config, data):
    ...
    # 4. Duplicate the image layer (at bottom)
    duplicate_layer = drawables[0].copy()
    image.insert_layer(duplicate_layer, None, 2)
